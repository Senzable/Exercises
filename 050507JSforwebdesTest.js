...
function initMap() {
	...
	var popupContentHollywood += '1750 Vine St<br>';
	var popupContentHollywood += 'Los Angeles, CA';
    
    var popupContentChavez = 'H+ Sport Chavez Ravine<br>';
	var popupContentChavez += '1000 Vin Scully Ave<br>';
	var popupContentChavez += 'Los Angeles, CA';
	
	var infowindowHollywovarod = new google.maps.InfoWindow({
	...
	markerHollywood.addListener('click', function() {
		infowindow.open(map, markerHollywood);
	   });
